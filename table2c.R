...
tab = table(banco$sex,banco$d3_p)
t = tab[,1]+tab[,2]
p = 100*tab[,2]/t
s = rep(NA,length(t))
...
tab = table(banco$age,banco$d3_p)
t = tab[,1]+tab[,2]
p = 100*tab[,2]/t
s = rep(NA,length(t))
for(i in 1:length(tab[,2])){
...
tab = table(banco$BMI,banco$d3_p)
t = tab[,1]+tab[,2]
p = 100*tab[,2]/t
s = rep(NA,length(t))
for(i in 1:length(tab[,2])){
...
tab = table(banco$Ethnie,banco$d3_p)
t = tab[,1]+tab[,2]
p = 100*tab[,2]/t
s = rep(NA,length(t))
for(i in 1:length(tab[,2])){
...
tab = table(banco$type,banco$d3_p)
t = tab[,1]+tab[,2]
p = 100*tab[,2]/t
s = rep(NA,length(t))
for(i in 1:length(tab[,2])){
...
tab = table(banco$tx_time,banco$d3_p)
t = tab[,1]+tab[,2]
p = 100*tab[,2]/t
s = rep(NA,length(t))
for(i in 1:length(tab[,2])){
...
tab = table(banco$tx_rank,banco$d3_p)
t = tab[,1]+tab[,2]
p = 100*tab[,2]/t
s = rep(NA,length(t))
for(i in 1:length(tab[,2])){
...
tab = table(banco$Diabetes,banco$d3_p)
t = tab[,1]+tab[,2]
p = 100*tab[,2]/t
s = rep(NA,length(t))
for(i in 1:length(tab[,2])){
...
tab = table(banco$HTA,banco$d3_p)
t = tab[,1]+tab[,2]
p = 100*tab[,2]/t
s = rep(NA,length(t))
for(i in 1:length(tab[,2])){
...
tab = table(banco$GFR_30,banco$d3_p)
t = tab[,1]+tab[,2]
p = 100*tab[,2]/t
s = rep(NA,length(t))
for(i in 1:length(tab[,2])){
...
tab = table(banco$Cancer,banco$d3_p)
t = tab[,1]+tab[,2]
p = 100*tab[,2]/t
s = rep(NA,length(t))
for(i in 1:length(tab[,2])){
...
tab = table(banco$CTC,banco$d3_p)
t = tab[,1]+tab[,2]
p = 100*tab[,2]/t
s = rep(NA,length(t))
for(i in 1:length(tab[,2])){
...
tab = table(banco$AZA,banco$d3_p)
t = tab[,1]+tab[,2]
p = 100*tab[,2]/t
s = rep(NA,length(t))
for(i in 1:length(tab[,2])){
...
tab = table(banco$MMF,banco$d3_p)
t = tab[,1]+tab[,2]
p = 100*tab[,2]/t
s = rep(NA,length(t))
for(i in 1:length(tab[,2])){
...
tab = table(banco$Evero,banco$d3_p)
t = tab[,1]+tab[,2]
p = 100*tab[,2]/t
s = rep(NA,length(t))
for(i in 1:length(tab[,2])){
...
tab = table(banco$CsA,banco$d3_p)
t = tab[,1]+tab[,2]
p = 100*tab[,2]/t
s = rep(NA,length(t))
for(i in 1:length(tab[,2])){
...
tab = table(banco$Induction_treatment,banco$d3_p)
t = tab[,1]+tab[,2]
p = 100*tab[,2]/t
s = rep(NA,length(t))
for(i in 1:length(tab[,2])){
...
tab = table(banco$n_treatments,banco$d3_p)
t = tab[,1]+tab[,2]
p = 100*tab[,2]/t
s = rep(NA,length(t))
for(i in 1:length(tab[,2])){
...
var = c("Cancer","CV","HTA","Diabetes","tx_rank","Ethnie","BMI","tx_time","FK","CTC","AZA","Evero")
acepted = c("GFR_30","MMF","type","n_treatments","CsA")
...
for(i in 1:length(var)){
  s = paste0("d3_p~",var[i],"+sex+age", ac)
...
var ="+sex+age+GFR_30+MMF+type+n_treatments+CsA"
# regression
# sex
v="sex"
model = glm(paste0("d3_p~",v,var),data = banco,family = binomial(link = "logit") )
...
var ="+sex+age+GFR_30+MMF+type+CsA"
